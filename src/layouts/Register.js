...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post(`https://hungry-fawn-bandanna.cyclic.app/register_usuario`, user);
  ...
  const handleDeleteUsers = async () => {
    try {
      const response = await axios.delete(`https://hungry-fawn-bandanna.cyclic.app/deleteAllUsers`);
