...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post(`https://bored-cuff-links-foal.cyclic.app/register_usuario`, user);
  ...
  const handleDeleteUsers = async () => {
    try {
      const response = await axios.delete(`https://bored-cuff-links-foal.cyclic.app/deleteAllUsers`);
