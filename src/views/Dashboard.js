...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://hungry-fawn-bandanna.cyclic.app/api/evaluations/count?instituicaoNome=${instituicaoNome}`)
      .then(response => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://hungry-fawn-bandanna.cyclic.app/api/UserCountByInstitution?instituicaoNome=${institutionName}`)
      .then(response => {
