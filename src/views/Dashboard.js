...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://bored-cuff-links-foal.cyclic.app/api/evaluations/count?instituicaoNome=${instituicaoNome}`)
      .then(response => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://bored-cuff-links-foal.cyclic.app/api/UserCountByInstitution?instituicaoNome=${institutionName}`)
      .then(response => {
