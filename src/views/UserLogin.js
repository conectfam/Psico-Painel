...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    axios
      .post("https://bored-cuff-links-foal.cyclic.app/api/user/login", {
        Email: email,
        senha: senha,
      })
      .then((response) => {
  ...
  return (
    ...
    <Container className="login-container" style={{ height: '100vh', marginTop: '100px'}}>
      <Col md={{ span: 6, offset: 3 }}>
        <Card>
        <Card.Body>
          <center><img src="https://imgur.com/F7oe830.png" style={{ width: '80%', height: 'auto', marginBottom: '5px' }} alt="logo" /></center>
          ...
          <div style={{ height: '20px' }}></div>
            <Form>
              ...
              <Button className="login-button w-100" type="submit" style={{ backgroundColor: '#3E4095' }} variant="primary" onClick={handleLogin} block>Logar</Button>
            </Form>
