...
const PrimeiroAcesso = () => {
  ...
  const verifyUser = async (event) => {
    ...
    try {
      const response = await axios.post('https://bored-cuff-links-foal.cyclic.app/api/verifyUser', { Email });
  ...
  const registerPassword = async () => {
    try {
      const response = await axios.post('https://bored-cuff-links-foal.cyclic.app/api/registerPassword', { Email, Senha });
      if (response.data.success) {
