...
const PrimeiroAcesso = () => {
  ...
  const verifyUser = async (event) => {
    ...
    try {
      const response = await axios.post('https://hungry-fawn-bandanna.cyclic.app/api/verifyUser', { Email });
  ...
  const registerPassword = async () => {
    try {
      const response = await axios.post('https://hungry-fawn-bandanna.cyclic.app/api/registerPassword', { Email, Senha });
      if (response.data.success) {
